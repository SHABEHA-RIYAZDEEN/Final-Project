            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-6">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <Link to="/login" className="px-3 py-2 rounded-md text-xs font-medium flex items-center hover:bg-blue-700">Login</Link>
                    </div>
                    <div className="flex items-center space-x-4">
                ...
                <div className="text-center text-xs font-medium py-4">
                    © {new Date().getFullYear()} Emotion Recognition System. All rights reserved.
                </div>
            </div>
        </footer>
    );
